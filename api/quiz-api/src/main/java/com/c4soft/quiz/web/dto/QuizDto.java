 ...
 * @param isChoicesShuffled           should the choices display order be shuffled from a question display to another
 * @param isReplayEnabled             can a trainee submit a new answer before his former one was deleted by the trainer
 * @param isPerQuestionResult         should the right answer as well as comment be displayed as soon as choices are validated for a question or only when the
 *                                    skill test was accepted by the server
