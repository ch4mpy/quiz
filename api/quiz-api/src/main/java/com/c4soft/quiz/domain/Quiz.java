...
public class Quiz {
  ...
  public Question getQuestion(Long questionId) {
    ...
    return questions.stream().filter(q -> questionId.equals(q.getId())).findAny().orElse(null);
  }
  ...
  public Quiz add(Question question) {
    ...
    questions.sort((a, b) -> (a.getPriority() == null ? questions.size() -1 : a.getPriority()) - (b.getPriority() == null ? questions.size() -1 : b.getPriority()));
    return this;
  }
  ...
  public Quiz remove(Question question) {
    ...
    if (isRemoved) {
      questions.stream().filter(q -> q.getPriority() >= question.getPriority())
          .forEach(q -> q.setPriority((q.getPriority() == null ? questions.size() -1 : q.getPriority()) - 1));
    }
    return this;
  }
}
